...
const EMPLOYEE_INFO = [
    { label: "Employee ID", value: "DL12345" },
    { label: "Phone", value: "+91 87654 32109" },
    { label: "Email", value: "delivery@example.com" },
    { label: "Joined On", value: "15 Feb 2024" },
];
        ...
        <SafeAreaView style={styles.safe}>
            ...
            <ScrollView style={styles.body} contentContainerStyle={{ padding: 16 }}>
                <View style={styles.card}>
                    ...
                    <Text style={styles.name}>Delivery User</Text>
                    <Text style={styles.role}>Delivery Executive</Text>
