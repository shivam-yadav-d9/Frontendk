        ...
        <SafeAreaView style={styles.safe} edges={["top"]}>
            ...
            >
                ...
                <View style={styles.statsRow}>
                    ...
                    <View style={styles.statCard}>
                        <MaterialIcons name="place" size={22} color={GREEN} />
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.sessionCard}>
                        ...
                        <View style={styles.detailRow}>
                            ...
                            <Text style={[styles.detailValue, { color: GREEN }]}>Present</Text>
                        </View>
                    </View>
                            ...
                            >
                                ...
                                <View
                                    style={[
                                        ...
                                        {
                                            backgroundColor:
                                                item.status === "Present" ? GREEN_LIGHT : "#FEE2E2",
                                        },
                                    ]}
                                >
                                    <Text
                                        style={[
                                            ...
                                            {
                                                color: item.status === "Present" ? GREEN : "#DC2626",
                                            },
                                        ]}
                                    >
                                        {item.status}
...
const styles = StyleSheet.create({
    ...
    badgeDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: GREEN },
    badgeText: { color: GREEN, fontWeight: "700", fontSize: 12 },
    timeBox: {
        flexDirection: "row",
        alignItems: "center",
