// services/fitterAttendance.service.js
//
// Local-only "attendance backend" for the Fitter role.
...
const HISTORY_KEY = "fitterAttendanceHistory";
export const STATUS_CACHE_TTL = 5000;

class FitterAttendanceService {
    constructor() {
    ...
    async _readHistory() {
        try {
            ...
            console.error("[FitterAttendance] read error:", e);
            return [];
        }
    }
    ...
    async _writeHistory(history) {
        try {
            ...
            console.error("[FitterAttendance] write error:", e);
        }
    }
...
export default new FitterAttendanceService();